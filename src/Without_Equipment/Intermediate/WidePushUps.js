    ...
    return (
        <View style={styles.main}>
            ...
            <View style={styles.GIFBOX}>
                <FastImage
                    source={{
                        uri: 'https://boxingholic.com/wp-content/uploads/2020/12/wide-pushups.gif',
            ...
            <View
                ...
                <Text style={styles.DESBOXTXT}>
                    ...
                    apart.
                    {'\n'}
                    {'\u2022'} Lower your body and push back up, engaging your chest and
                    shoulders.
